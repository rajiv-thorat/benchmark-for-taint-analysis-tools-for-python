...
class PysaHarness(Harness):
    def run_tool_on_synthetic_tests(self):
        ...
        # docker run -it -v /home/rajiv/git/MasterArbeit/submodules/benchmark-for-taint-analysis-tools-for-python/test-harness/pysa_files/pysa_config:/config -v /home/rajiv/git/MasterArbeit/submodules/benchmark-for-taint-analysis-tools-for-python/tests/synthetic_taint_data/if_statement_1:/code -v /home/rajiv/git/MasterArbeit/submodules/benchmark-for-taint-analysis-tools-for-python/test_metadata/outputs_raw/pysa/if_statement_1:/op local/pysa
